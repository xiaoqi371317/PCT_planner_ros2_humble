...
macro(find_openni2)
  ...
  if(NOT OPENNI2_ROOT AND ("TRUE" STREQUAL "TRUE"))
    ...
    get_filename_component(OPENNI2_LIBRARY_HINT "/usr/lib/x86_64-linux-gnu/libOpenNI2.so" PATH)
  endif()
...
macro(find_VTK)
  ...
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "/usr/lib/x86_64-linux-gnu/cmake/vtk-9.1" CACHE PATH "The directory containing VTKConfig.cmake")
  endif()
  if(NOT ANDROID)
...
set(pcl_all_components  common kdtree octree search sample_consensus filters 2d geometry io features ml segmentation visualization keypoints outofcore people)
...
set(pcl_io_opt_dep openni openni2 pcap png vtk libusb OpenMP )
